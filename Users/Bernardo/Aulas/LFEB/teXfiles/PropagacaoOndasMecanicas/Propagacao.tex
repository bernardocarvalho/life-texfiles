...
%	 \frac{2\,\Delta x_0}{T/2} c_{ar} = \frac{2\,\Delta x_0}{T/2} 
...
do fio entre a posição mais alta e mais baixa da trajetória. Qual a variação máxima que esta aleração do comprimento provoca no período?
...
Aplicando a derivada parcial em ordem a x à equação (\ref{eq:a4}) obtem-se
\begin{equation}
	\label{eq:a6}
	\frac{\partial F }{\partial x} = A \, Y \frac{\partial^2 \xi }{\partial x^2}
\end{equation}	

Combinando (\ref{eq:a5}) e (\ref{eq:a6}) obtem-se a equação 
\begin{equation}
	\label{eq:a7}
