...
\markboth{{\small\it MEFT - 2012/2013}}
...
Com a ajuda de um colega e de uma régua graduada obtenha 15 medidas do seu tempo de reacção e obtenha o seu valor médio e a incerteza.

Monte o sistema de pêndulo gravítico e obtenha o seu período para diversos comprimentos do fio. 
Obtenha o valor de $g_{exp}$ para estes ensaios, usando a expressão (9) do texto, bem como a respectiva incerteza experimental. 
...
Tenha em atenção os seguintes aspectos:
 \begin{flushleft}
	 ...
	 $\bullet$ Como pode minimizar a incerteza da medição do período? Usando um ou mais ciclos? \\
	 $\bullet$ Verifique experimentalmente que o período do pêndulo não depende do valor da massa.\\
	 $\bullet$ Verifique experimentalmente a dependência do ângulo máximo no período do pêndulo. Para que valores de $\theta_0$ deixamos de poder usar a equação (9), com um desvio de $g_{exp}$ superior a uma décima?\\
	 $\bullet$ Tente estimar a percentagem de energia  devido ao atrito que se perde em cada ciclo e calcule o  factor $Q$  e a sua influencia no período.
\end{flushleft} 
