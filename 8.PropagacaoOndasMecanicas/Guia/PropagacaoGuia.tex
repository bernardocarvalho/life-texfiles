...
{{\small\it MEFT - 1º Sem.  2017/2018} }
...
%	\captionof{figure}{Montagem experimental para medir a velocidade de ondas P e S. \label{fig:fig3}}
\end{minipage}
...
\end{minipage}
\begin{center}
	\captionof{figure}{Montagem experimental para medir a velocidade de ondas P e S. \label{fig:fig4}}
\end{center}
