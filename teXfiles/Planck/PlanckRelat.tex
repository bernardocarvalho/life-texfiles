...
%Número: _______ Nome: ________________ \\
{  \sf \Large Relatório do Efeito fotoeléctrico.} %[0.4cm] % \bfseries 
Turno:\underline{\makebox[1.5cm][l]{~}} Grupo:\underline{\makebox[0.7cm][l]{~}} Data:\underline{\makebox[1.5 cm][l]{~}}\\
