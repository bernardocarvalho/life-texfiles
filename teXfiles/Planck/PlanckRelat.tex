...
%Número: _______ Nome: ________________ \\
{  \sf  \textsc{Relatório do Efeito fotoeléctrico}} %[0.4cm] % \bfseries 
...
\item Assumindo que a rede tem $600\,linhas/mm$, obtenha uma tabela de ângulos de difração para 3 Ordens e todas as cores.
...
\begin{itemize}
\item Preencha a tabela seguinte:
\end{itemize}
...
\item Faça também o ajuste com o auxílio de software adequado (calculadora gráfica gnuplot, ~~~... ). Compare os dois métodos e obtenha o valores de $h$ e $W$ a partir do resultado mais fiável.  
\end{itemize}
