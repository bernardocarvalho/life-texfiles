...
%Número: _______ Nome: ________________ \\
{  \sf  Relatório da Experiência de Millikan.} %[0.4cm] % \bfseries 
...
%    \draw (0,0) -- coordinate (y axis mid) (0,1.7);
	%labels      
	\node[below=0.3cm] at (27.0,0)  {$q_{gota}\;\; \times \mathrm{10^{-19}\, C} $ };
    	%ticks
    	\foreach \x in {0,5,...,25}
...
Supondo que não conhecia o valor tabelado da carga do electrão, e apenas a partir dos resultados obtidos, poderá tirar conclusões sobre a quantificação da carga eléctrica?
